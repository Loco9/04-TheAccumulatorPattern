...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(4, 5, 0.1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(1, 7, 0.8)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = count_cosines_from(1, 4, 0.01)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(1, 11, 0.3)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(2, 6, 0.2)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 2.103211
    answer = sum_unit_fractions_from(2, 12)
